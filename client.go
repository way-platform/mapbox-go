...
// Use this to inject observability (metrics, tracing) without adding GCP-specific
// code to this SDK. The SDK layers auth (token injection) and retry on top of the
// provided transport so every outbound API call passes through it.
...
func userAgent() string {
	const base = "WayPlatformMapboxGo"
